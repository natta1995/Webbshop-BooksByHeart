    ...
    <div>
      ...
      <div style={sectionStyle}>
        ...
        <div style={sectionContentStyle}>
          ...
          Vi får ofta frågan om varför vi valde att skapa BooksByHeart. Förutom vårt nu gemensamma intresse för böcker och läsning, var det faktiskt en annan anledning som gjorde att de båda tjejerna redan på högstadiet bestämde sig för att i framtiden skapa ett företag med fokus på läsning. <br></br> För Agnes har läsning varit en naturlig del redan innan hon själv ens kunde läsa. För Elsa har det istället varit en evig kamp att lära sig läsa och sedan hålla sig i kapp med klasskamraterna. Diagnosen dyslexi kom först i sena tonåren, men tack vare Agnes kunde hon se det fina med läsning och inte bara all kamp. <br></br> <br></br>Tillsammans är de rörande överens om att läsning är något som behöver introduceras i tidig ålder, och inte bara som något man måste lära sig, utan som något roligt och berikande. 
          </p>
      ...
      <div style={sectionStyle}>
        ...
        <div style={sectionContentStyle}>
          ...
          <p style={{marginLeft: "0%", marginRight: "10%"}}>
          Petra är en av våra yngsta prenumeranter. Efter att ha varit enda barnet i sexton år fick hennes mamma och hennes nya man ett tillskott. <br></br> Petra berättar hur hon tyckte det var roligt men var samtidigt lite ledsen över att få ett syskon så sent i livet. <br></br>"Jag var rädd att vi inte skulle kunna få någon bra relation. Både på grund av den stora åldersskillnaden men också för att jag bara bor där varannan vecka. Dessutom ser jag att jag inom några år kommer flytta hemifrån. Därför kände jag att jag ville ha något som bara var vår grej", förklarar hon. <br></br> Därför började hon redan när Adam var ett år att prenumerera på BooksByHeart. Förra året tog Petra studenten och har sedan förra året lämnat Stockholm och bosatt sig i Borås där hon studerar till läkare. Men så ofta hon kan åker hon och hälsar på sin lillebror. <br></br> <br></br>"Nu till sommaren har jag sökt ett jobb i hemtrakten och kommer kunna träffa honom mycket mer. Men det är så kul för läsning och böcker har verkligen blivit vår grej. Nu sist när han och mamma mötte upp mig vid tåget hade han redan en bok i handen. Jag var tvungen att läsa den för honom i bilen", säger hon och skrattar.
          </p>
          <div style={{display: "flex", justifyContent: "flex-end", alignSelf: "flex-end", marginTop: "10%", marginRight: "8%"}}>
          <Link to="/"> Läs hela artikeln</Link>
          </div>
